...
class MeasureWidgetWithSecondaryParameters(MeasureWidget):
    ...
    def __init__(self, parent=None, controller=None):
        ...
        self._spinFhetDelta.setSingleStep(1)
        self._spinFhetDelta.setValue(0)
        ...
        self._spinFinDelta.setSingleStep(1)
        self._spinFinDelta.setValue(0)
